...
public class SpawnLimitsConfig {
    ...
    private void Init() {
        if (_mLimitedEntities == null) _mLimitedEntities = new ArrayList<SpawnLimitsConfig.LimitedEntity>();
    }
    ...
    public static class LimitedEntity {
        ...
        private void Init() {
            if (mWorldConfig == null) mWorldConfig = new ArrayList<SpawnLimitsConfig.LimitedEntity.SpawnLimitWorld>();
        }
