...
public class GuiAMDI extends GuiContainer
{
	...
	public GuiAMDI( InventoryPlayer pInventoryPlayer, int pLootGroupMeta )
	{
	...
	protected void drawGuiContainerBackgroundLayer( float pPar1, int pPar2, int pPar3 )
	{
		...
		mc.renderEngine.bindTexture( new ResourceLocation( AMDIForge.MODID, "textures/gui/amdigui.png" ) );
